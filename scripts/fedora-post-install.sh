...
dnf -y install git libtool autoconf automake flex bison openssl openssl-devel libibverbs-devel readline-devel libxml-devel libaio-devel libxml2-devel librdmacm librdmacm-devel
#install awesome vim
